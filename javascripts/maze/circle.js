...
function Circle(id, maze, row, col, color, assassin, mask){
  ...
  if(mask){
    this.mask = maze.paper.image( assassin ? "images/maze/mask-bad.png" : "images/maze/mask-good.png" ,
  ...
  this.changeType = function(is_assassin){
    ...
    if( typeof(this.mask) != "undefined"){
      this.mask.attr({src: is_assassin ? "images/maze/mask-bad.png" : "images/maze/mask-good.png"});
    }
